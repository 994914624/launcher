...
public class WeatherActivity extends BaseActivity {
    ...
    // 北京气象局
    private static final String WEATHER_URL_2 = "https://bjwx.91weather.com/bjwx/app/forecast/day?";
    private static final String TAG = "WeatherActivity";

    private TextView locationCity;
    private final ArrayList<ImageView> imgList = new ArrayList<ImageView>();
    // 高德定位
    ...
    private void initView() {
        //今天 明天 后天 大后天
        ImageView imgToday = (ImageView) findViewById(R.id.img_today);
        ImageView imgTomorrow = (ImageView) findViewById(R.id.img_tomorrow);
        ImageView imgNextDay = (ImageView) findViewById(R.id.img_nextDay);
        ImageView imgNextNextDay = (ImageView) findViewById(R.id.img_nextnextDay);
...
//                            Log.e(TAG, "gaode-GPS: " + desLatLng.getLatitude() +" "+ desLatLng.getLongitude());
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
...
//                            Log.e("--------",""+json);
                        ...
                        for (int i = 1; i < 5; i++) {
                            ...
                            stringBuilder.append(fx).append("风").append(fl).append("\n          ");
                        }
                        // 播放语音
                        SpeechUtil.startSpeaking(stringBuilder.toString());
                    } catch (Exception e2) {
